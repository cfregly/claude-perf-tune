...
- Open a private report through GitHub Security Advisories: <https://github.com/cfregly/claude-perf-tune/security/advisories/new> (repo **Security** tab → **Advisories** → **Report a vulnerability**).
...
Security reports: through [GitHub Security Advisories](https://github.com/cfregly/claude-perf-tune/security/advisories/new).
